...
{            
    ...
    public class GraphService
    {
        ...
        public async Task<string> GetMyEmailAddress(string accessToken)
        {
            ...
            OfficeHoursUserInfo me = new OfficeHoursUserInfo();
        ...
        public async Task<OfficeHoursFileInfo> UploadFile(string accessToken, Stream file)
        {
                ...
                using (var request = new HttpRequestMessage(HttpMethod.Put, endpoint))
                {
                    ...
                    using (var response = await client.SendAsync(request))
                    {
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            return JsonConvert.DeserializeObject<OfficeHoursFileInfo>(stringResult);
                        }
                        else return null;
                    }
                }
        ...
        public async Task<string> SendEmail(string accessToken, OfficeHoursMessageRequest email)
        {
